...
| 10 | Mihomo 管理 | 安装/更新、可选定时自动更新、生成配置 (SS/AnyTLS/HY2/WireGuard 入站)、读取配置导出节点、自启动、重启、查看日志；支持出口管理（含链式代理）、Google/Netflix/端口出站分流、自定义远程规则集 (yaml/text/mrs)、socks5 链接导入 |
